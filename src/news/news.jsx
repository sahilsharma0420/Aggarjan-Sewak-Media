    ...
    <div className="secondpage">
      <div className="main-header">
        ...
        <div className="side-header">
          <div className="news-search-bar">
            <Button variant="outlined" style={{ border: "none" }}>
              <div className="searchbar">
                ...
                />
                <p className="secondpage-city">शहर चुनें</p>
                <img
                  style={{ marginLeft: "5px" }}
                  src={`https://file.rendit.io/n/sp3hR6uIj84vmabeo31W.svg`}
                />
                <p className="secondpage-search">खोज के लिए यहाँ लिखें</p>{" "}
                <img
          ...
          <div className="button3">
            <Button style={{ color: "black" }}>
              {" "}
              <div className="name">
                <p className="namevalue" style={{ textAlign: "left" }}>
                  Ankush Jain
                </p>
        ...
        <div className="hamburger-menu">
          <button className="icon-button1" onClick={() => setuser(!user)}>
            <MenuIcon />
          </button>
        </div>
      ...
      {user && (
        ...
        <img className="side-logopic" src={process.env.PUBLIC_URL + `/images/logo1.png`} alt="location"></img>
        <span className="imcross">
       <button className="icon-button2" onClick={()=>setuser(!user)}>
       <CloseIcon/></button></span>
          ...
          <div className="slider-buttons">
            <div className="slider-button2">
              <Button style={{ color: "black" }}>
                {" "}
                <div className="slider-news-addition">
                  <img
            ...
            <div className="slider-button3">
              <Button style={{ color: "black" }}>
                ...
                <div className="slider-name">
                  <p className="slider-namevalue" style={{ textAlign: "left" }}>
                    Ankush Jain
                  </p>
                  <p className="namevalue">v</p>
                </div>
      ...
      <div className="content">
        <div className="left-content">
          <div className="courtroom">
            <div className="courtroom-information">
              <img
                ...
                src="https://file.rendit.io/n/ooqUNHCMPqGEgFE4X9EC.svg"
              />
              <div className="courtroom-text">
                <p className="courtroom-text1">
                  बरेली के मेडिसिटी अस्पताल के डॉक्टर समेत चार पर केस दर्ज
                </p>
                <img
                  className="loading"
                  src="https://file.rendit.io/n/6b9i5ZEbZ6PUUz4WKm25.svg"
                />
              </div>
              <img
              ...
              <div className="information-cover">
                <div className="information">
                  ...
                  <div>
                    <div className="news">
                      {" "}
                      पाक युवती के प्यार में सरहद पार कर गया फर्रुखाबाद का
                      लड़का, अब...
                    </div>
          ...
          <div className="right-content1">
            <div className="right-content1-left">
              <div className="person">
                <img
                  ...
                  src="https://file.rendit.io/n/Gkqez6820weLUO8GIzku.png"
                />
                <div className="person-date">
                  पंजाब के IAS अफसर संजय पोपली और उनके सचिव गिरफ्तार, टेंडर
                  मंजूर करने को ठेकेदार से मांगी थी कमीशन
                </div>
              </div>
              <div className="person">
                <img
            ...
            <div className="right-content1-right">
              <img
                className="lg-yoga-right"
                src="https://file.rendit.io/n/dQN3w334whoBeoQaN7HE.png"
              />
        ...
        <div className="right-content">
          ...
          <div className="person">
            ...
            />
            <div className="person-date">
              पंजाब के IAS अफसर संजय पोपली और उनके सचिव गिरफ्तार, टेंडर मंजूर
              करने को ठेकेदार से मांगी थी कमीशन
            </div>
          </div>
          <div className="person">
            <img
      ...
      <div className="mobile-content">
        ...
        <div className="mobile-lower-information">
          ...
          <div className="mobile-person">
            <img
              className="mobile-person-image"
              src="https://file.rendit.io/n/Gkqez6820weLUO8GIzku.png"
            />
            <div className="mobile-person-date">
              पंजाब के IAS अफसर संजय पोपली और उनके सचिव गिरफ्तार, टेंडर मंजूर
              करने को ठेकेदार से मांगी थी कमीशन
            </div>
          </div>
          <img
            className="mobile-lg-yoga1"
            src="https://file.rendit.io/n/dQN3w334whoBeoQaN7HE.png"
          />
          <div className="mobile-person">
            <img
